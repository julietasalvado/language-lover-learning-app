...
<custom-style>
  <style>
    html {
      --lumo-primary-color: hsl(312, 13%, 51%);
      --lumo-error-color: hsl(3, 55%, 67%);
      --lumo-error-text-color: hsl(3, 86%, 68%);
      --lumo-success-color: hsl(145, 31%, 75%);
      --lumo-success-text-color: hsl(145, 24%, 53%);
      --lumo-base-color: #e5dbd6;
      --lumo-body-text-color: hsla(214, 24%, 19%, 0.94);
