package com.languagelover.learningapp.views.languageloverlearningapp;
...
@PageTitle("Language Lover Learning App")
@CssImport(value = "styles/views/languageloverlearningapp/language-lover-learning-app-view.css", include = "lumo-badge")
@JsModule("@vaadin/vaadin-lumo-styles/badge.js")
public class LanguageLoverLearningAppView extends Div implements AfterNavigationObserver {
    ...
    public LanguageLoverLearningAppView() {
        setId("language-lover-learning-app-view");
